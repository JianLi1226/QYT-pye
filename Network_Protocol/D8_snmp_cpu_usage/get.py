...
if __name__ == "__main__":
    ...
    # cpmCPUMemoryUsed
    print(snmpv2_get("192.168.1.131", "tcpipro", "1.3.6.1.4.1.9.9.109.1.1.1.1.12.7", port=161))
    # cpmCPUMemoryFree
    print(snmpv2_get("192.168.1.131", "tcpipro", "1.3.6.1.4.1.9.9.109.1.1.1.1.13.7", port=161))